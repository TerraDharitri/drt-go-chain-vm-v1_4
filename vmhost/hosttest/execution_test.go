...
import (
	...
	"github.com/TerraDharitri/drt-go-chain-vm-v1_4/config"
	vmMath "github.com/TerraDharitri/drt-go-chain-vm-v1_4/math"
	contextmock "github.com/TerraDharitri/drt-go-chain-vm-v1_4/mock/context"
	"github.com/TerraDharitri/drt-go-chain-vm-v1_4/mock/contracts"
	test "github.com/TerraDharitri/drt-go-chain-vm-v1_4/testcommon"
	"github.com/TerraDharitri/drt-go-chain-vm-v1_4/vmhost"
	vmMock "github.com/TerraDharitri/drt-go-chain-vm-v1_4/vmhost/mock"
	"github.com/TerraDharitri/drt-go-chain-vm-v1_4/vmhost/vmhooks"
...
func BenchmarkOpcodeMemoryGrow(b *testing.B) {
	...
	maxDelta := uint32(10)
	argDelta := int64(10)
	// Run with a fixed number of iterations to avoid timeout
	runMemGrowTest(b, maxGrows, maxDelta, argDelta, 10, vmcommon.Ok)
}
